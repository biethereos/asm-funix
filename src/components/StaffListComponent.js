...
import { Card, CardImg, CardBody, CardTitle, Modal, ModalHeader, ModalBody, Label, Col, Button, Row } from 'reactstrap';
...
class StaffList extends Component {
	...
	handleSubmit = (values) => {
		...
		const department = this.props.departments.find(v => v.name === values.department);
		const image = '/assets/images/alberto.png';
		const staff = {...values, image};
		staff.department = department;
		staff.department.numberOfStaff++;
		staff.image = image;
	...
	render() {
		...
		const filteredData = this.props.staffs.staffs.filter((item) => {
